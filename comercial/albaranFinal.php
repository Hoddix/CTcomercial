...
<div id="content"></div>
  <div class="container-fluid">
        ...
        <nav class="navbar navbar-inverse" role="navigation">
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse-01">      
            <ul class="nav navbar-nav">           
              <li class="active"><a href="albaranFinal.php">CREAR ALBARAN</a></li>
    ...
    <section>
        ...
        <div class="row" id="cabeceraAlbaran"> 
            ...
            <div class="col-xs-12 col-md-4 col-md-offset-2" id="cliente">                
            ...
            <div class="col-xs-12 col-md-4 col-md-offset-2" id="datosAlbaran">
        ...
        <div class="row" id="addProductos">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="productos" placeholder="Buscar productos"> 
                    <span class="icono-borrar" id="erase" style="display:none;color:#bdc3c7;z-index:10000;"><h6>x</h6></span>    
                </div>
        ...
        <div class="table-responsive" id="tabla">
            <table class="table editabletable">
                <thead>
                    <tr>
                    <th>#</th>
                    <th>#</th>
        ...
        <div id="botones">
            <button class="btn btn-primary" id="addAlbaran">Guardar Albaran</button>
        </div>
    </section>
<!-- /.container -->
</div>
