  ...
  <div class="container-fluid">
        ...
        <nav class="navbar navbar-inverse" role="navigation">
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse-01">          
            <ul class="nav navbar-nav">           
              ...
              <li class="active"><a href="reciboFinal.php">CREAR RECIBO</a></li>
    ...
    <section>
        ...
        <div class="row" id="cabeceraFactura">
            ...
            <div class="col-xs-12 col-md-4 col-md-offset-2" id="datosFactura">
        ...
        <div id="botones">
            <button class="btn btn-primary" id="addRecibo">Guardar Recibo</button>
        </div>
    </section>
<!-- /.container -->
</div>
